...
def lowlight(image_path):
	...
	light_net_test.load_state_dict(torch.load('snapshots_light/Epoch100.pth')['net_decay'])
	...
	image_path = image_path.replace('dark_200','face_small')
	# image_path = image_path.replace('LSRW', 'result')
	# image_path = image_path.replace('data','small_lit/data')
